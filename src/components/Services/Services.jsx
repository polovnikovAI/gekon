                ...
                <div className={cl.cleanVinyl}>
                    ...
                    <div className={cl.cleanVinylCard}>
                        <div className={cl.cleanVinylTextCard}>
                            ...
                            <br/>
                            <p className={cl.cleanVinylTextCardPart}>Также, на блине часто остаются жирные пятна и следы от рук.</p>
                        </div>
                        <img src={require('./photosServices/vinylCleaner.jpeg')} alt="Vinyl Cleaner" className={cl.cleanVinylPhoto}/>
                    </div>
                </div>
